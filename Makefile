...
build-safescaled-image:
	...
	rm scaler/build/sf.tar.gz
	sudo docker build -t artifactory.coprs.esa-copernicus.eu/rs-docker/safescaled:${SAFESCALE_TAG} -f scaler/safescaled.Dockerfile .
